...
class SearchQueryExtractionAgent implements Agent, HasStructuredOutput
{
    ...
    public function instructions(): Stringable|string
    {
        ...
        - clarifying_question: если subject отсутствует или место не названо (и не «любое») — задай
          ОДИН короткий вопрос про самое важное недостающее: сначала про предмет поиска, потом про
          место. Если всё есть — пустая строка. Вопрос живой и короткий, на «вы», ТОЛЬКО на русском
          языке — даже если заказчик написал по-казахски. Без канцелярита и без глаголов первого
          лица в прошедшем времени («нашла», «поняла» — так не пиши). Можно опереться на уже
          понятое («Кран — понятно. В каком городе он нужен?»).
        - user_intent: к чему относится последнее сообщение заказчика.
          ...
          объявление, закончить разговор.
          "menu" — заказчик просит вернуться в главное меню, начать сначала или открыть другой
          раздел.

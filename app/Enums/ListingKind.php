...
enum ListingKind: string
{
     ...
     *
     * Equipment the dictionary lacks does not leave category or
     * machine_categories empty: the collector adds it as a new category
     * awaiting the operator. The driver's «Нет в списке» exit (machinery
     * kept in words, field closed without a category) is still honoured for
     * a dialog that got there before that; the collector owns that
     * exception, and this list stays the plain «what publication needs
     * from the dialog».
     *
     * @return list<string>
     */
    ...
    public function greeting(): string
    {
        return match ($this) {
            ...
            self::Repair => 'Расскажите о себе: какие работы выполняете, в своём сервисе или с выездом, в каком городе, сколько стоит диагностика. Напишите или наговорите голосом.',
            self::Driver => 'Расскажите о себе: на какой технике работаете, какое удостоверение, сколько лет стажа, в каком городе, готовы ли выезжать. Напишите или наговорите голосом.',
        };
    }
}

...
class ListingMedia extends Model
{
    ...
    /**
     * The same URL, safe to drop into a CSS `url('…')` value. Stored paths
     * are generated by the application and never contain these characters,
     * but a quote or bracket sneaking into one would otherwise escape the
     * value and inject declarations into the inline style that carries it.
     */

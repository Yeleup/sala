...
export const scenes = [
    ...
    },
    {
        ...
        narration:
            ...
            'Обязательное поле всего одно — поставщик. Остальное можно дозаполнить позже: ' +
    ...
    },
    {
        id: 'listing-fields',
        narration:
            'Дальше — сам предмет разговора. Название, категория, марка, описание, локация, ' +
            'уточнение адреса, цена — всё это оператор набирает со слов клиента, ' +
